...
#dll = cdll.LoadLibrary("./libPlayerOneCamera.3.9.0.dylib") # Mac OS, please copy the 4 'dylib' files from 'lib' folder
...
# Elegir nombre según plataforma
if platform.system() == "Darwin":
    libname = "libPlayerOneCamera.3.9.0.dylib"
    dll = cdll.LoadLibrary(str(HERE / libname))
elif platform.system() == "Linux":
    libname = "libPlayerOneCamera.so"
    dll = cdll.LoadLibrary(str(HERE / libname))
elif platform.system() == "Windows":
    libname = "PlayerOneCamera.dll"
    # En Windows a veces necesitas agregar el dir al PATH de DLLs:
